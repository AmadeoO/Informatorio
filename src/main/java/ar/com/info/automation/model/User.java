...
public class User {
	...
	public User(String sex, String firstName, String lastName, String pass, String day, String month, String year,
			boolean newlester, boolean offer, String company, String address1, String address2, String city,
			String state, String postalCode, String aditionalInformation, String homePhone, String mobilPhone,
			String companyAddress, String addressLine2, String informationAditional) {
		super();
		this.sex = sex;
